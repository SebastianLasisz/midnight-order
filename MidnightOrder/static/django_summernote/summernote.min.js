!function (a) {
    ...
    var b, c = "function" == typeof define && define.amd, d = function (b) {
    ...
    }(), l = {version: "0.5.10", options: {width: null, height: null, minHeight: null, maxHeight: null, focus: !1, tabsize: 4, styleWithSpan: !0, disableLinkTarget: !1, disableDragAndDrop: !1, disableResizeEditor: !1, shortcuts: !0, codemirror: {mode: "text/html", htmlMode: !0, lineNumbers: !0}, lang: "en-US", direction: null, toolbar: [
        ["style", ["style"]],
        ...
        ["help", ["help"]]
    ], airMode: !1, airPopover: [
        ["color", ["color"]],
        ["font", ["bold", "underline", "clear"]],
        ["para", ["ul", "paragraph"]],
        ["table", ["table"]],
        ["insert", ["link", "picture"]]
    ], styleTags: ["p", "blockquote", "pre", "h1", "h2", "h3", "h4", "h5", "h6"], defaultFontName: "Helvetica Neue", fontNames: ["Arial", "Arial Black", "Comic Sans MS", "Courier New", "Helvetica Neue", "Impact", "Lucida Grande", "Tahoma", "Times New Roman", "Verdana"], colors: [
    ...
    }, nameFromCode: {8: "BACKSPACE", 9: "TAB", 13: "ENTER", 32: "SPACE", 48: "NUM0", 49: "NUM1", 50: "NUM2", 51: "NUM3", 52: "NUM4", 53: "NUM5", 54: "NUM6", 55: "NUM7", 56: "NUM8", 66: "B", 69: "E", 73: "I", 74: "J", 75: "K", 76: "L", 82: "R", 83: "S", 85: "U", 89: "Y", 90: "Z", 191: "SLASH", 219: "LEFTBRACKET", 220: "BACKSLASH", 221: "RIGHTBRACKET"}}, o = function () {
        var b = function (b, c) {
        ...
        this.fontSize = function (a, b) {
            document.execCommand("fontSize", false, 3), a.find("font[size=3]").removeAttr("size").css("font-size", b + "px"), i(a)
    ...
    var z = function () {
        ...
        var p = function (b) {
            ...
            if (j.isControlSizing(b.target)) {
                ...
                d.on("mousemove", function (a) {
                    h.resizeTo({x: a.clientX - o.left, y: a.clientY - (o.top - q)}, n, !a.shiftKey), l.update(e, {image: m}, r), k.update(f, {image: m}, r)
                }).one("mouseup", function () {
                    d.off("mousemove")
                }), n.data("ratio") || n.data("ratio", n.height() / n.width()), h.afterCommand(g)
            }
        }, D = function (b) {
        ...
        var b = function (a, b) {
            ...
            var b = [
                ...
                {kbd: "⌘ + ⇧ + S", text: a.font.sdivikethrough},
        ...
        this.createLayoutByAirMode = function (b, c) {
            ...
            c.height && l.height(c.height), c.direction && l.attr("dir", c.direction), l.html(j.html(b) || j.emptyPara), a('<textarea class="note-codable"></textarea>').prependTo(f);
    ...
    var B = new A, C = new z;
    a.extend(a.summernote, {renderer: B, eventHandler: C, core: {agent: e, dom: j, range: k}, pluginEvents: {}}), a.summernote.addPlugin = function (b) {
